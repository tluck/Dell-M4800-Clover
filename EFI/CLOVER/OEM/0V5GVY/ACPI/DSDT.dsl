 ...
 *
 * Disassembly of ./DSDT/raw/DSDT.aml, Wed Sep 16 12:40:59 2015
 *
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000014)
{
    ...
    External (AFN1, MethodObj)    // Warning: Unresolved method, guessing 1 arguments
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (PEG0)
        {
            ...
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                Store (LTRA, LTRS)
                Store (OBFA, OBFS)
// tjl - use to turn ATI card off               \_SB.PCI0.PEG0.PEGP._OFF()
            }
...
// tjl - remove Devices PEG1, PEG2, B0D3
// tjl - GFX0 is really IGPU
...
// tjl - set to Windows 2012
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (PS2K)
        {
            Name (_HID, "DLLK05CC")  // _HID: Hardware ID
        ...
        Device (PS2M)
        {
            Name (_HID, EisaId ("DLL05CC"))  // _HID: Hardware ID
